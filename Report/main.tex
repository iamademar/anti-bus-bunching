...
\author{Ademar Tutor, Member~2, Member~3, Member~4, Member~5, Member~6 \\
...
Engineer the causal features of Table~\ref{tab:feat} (all $\le t$): headway ratio, trend, boarding pressure, time-of-day\;
...
\texttt{loading}               & feature & Passengers on board (crowding proxy). \\
\texttt{recent\_boardings}     & feature & Boardings over this and the last 2 stops (demand pressure). \\
\texttt{pt\_sequence}          & feature & Position along the route. \\
\texttt{minute\_of\_day}       & feature & Time of day in minutes since midnight. \\
\texttt{dow}                   & feature & Day of week (0 = Monday). \\
...
\texttt{since\_prev}~=~since\_prev\_stop\_min, \texttt{recent\_b}~=~recent\_boardings,
\texttt{min\_day}~=~minute\_of\_day, \texttt{peak}~=~is\_peak. Note how the raw \texttt{stop\_time}
of Table~\ref{tab:odsample} turns into \texttt{min\_day} (802 = 13:22) and the per-stop gaps into
\texttt{since\_prev}; the load appears at \texttt{seq}~8 just as in the raw rows; and a bunched
...
\toprule
seq & headway & normal & ratio & trend & since\_prev & load & recent\_b & min\_day & dow & peak & label \\
\midrule
1  & 18.07 & 37.00 & 0.49 & -11.88 & 0.00 & 0.00 & 0.00 & 802 & 4 & 0 & 1 \\
2  & 18.13 & 37.14 & 0.49 & -12.08 & 0.33 & 0.00 & 0.00 & 802 & 4 & 0 & 1 \\
3  & 16.87 & 38.92 & 0.43 & -17.93 & 3.33 & 0.00 & 0.00 & 805 & 4 & 0 & 1 \\
4  & 16.75 & 39.02 & 0.43 & -19.32 & 1.17 & 0.00 & 0.00 & 806 & 4 & 0 & 1 \\
5  & 16.25 & 39.36 & 0.41 & -21.30 & 1.00 & 0.00 & 0.00 & 807 & 4 & 0 & 1 \\
6  & 16.22 & 40.14 & 0.40 & -22.53 & 1.18 & 0.00 & 0.00 & 809 & 4 & 0 & 2 \\
7  & 15.75 & 40.48 & 0.39 & -23.80 & 0.35 & 0.00 & 0.00 & 809 & 4 & 0 & 2 \\
\rowcolor{gray!15} 8  & 15.82 & 39.43 & 0.40 & -22.55 & 1.00 & 2.26 & 2.26 & 810 & 4 & 0 & 1 \\
9  & 16.35 & 38.34 & 0.43 & -21.42 & 1.87 & 2.26 & 2.26 & 812 & 4 & 0 & 1 \\
10 & 16.33 & 38.38 & 0.43 & -21.47 & 0.35 & 2.26 & 2.26 & 812 & 4 & 0 & 1 \\
11 & 16.35 & 34.40 & 0.48 & -10.13 & 0.80 & 3.39 & 1.13 & 813 & 4 & 0 & 1 \\
\bottomrule
\end{tabular}
\end{table}
